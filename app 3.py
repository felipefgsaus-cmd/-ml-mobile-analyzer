...
<p class="muted">API oficial + catálogo + reviews + perguntas + ofertas relacionadas. • Prompt Engine V2.1</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Prompt Mestre V2.1 - ML Analyzer V8.2</title>
<style>
body{font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;background:#f5f5f5;color:#202020;margin:0}
.wrap{max-width:1120px;margin:auto;padding:16px}
.card{background:#fff;border:1px solid #e1e1e1;border-radius:16px;padding:18px;margin:14px 0}
...
<p class="muted">Gerado localmente pelo ML Analyzer V8.2 usando os dados já coletados. Engine V2.1 focada em conversão. Nenhuma API de IA é necessária.</p>
<div class="card">
...
@app.route("/health")
def health():
    return {"ok":True,"version":"8.2","prompt_engine":"2.1","mode":"web"}
